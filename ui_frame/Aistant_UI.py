...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu.setGeometry(QtCore.QRect(496, 298, 120, 72))
        self.menu.setTearOffEnabled(False)
        self.menu.setObjectName("menu")
        self.menu_2 = QtWidgets.QMenu(self.menubar)
        self.menu_2.setGeometry(QtCore.QRect(576, 298, 120, 94))
        ...
        self.action_chatgpt.triggered.connect(self.stackedWidget.show) # type: ignore
